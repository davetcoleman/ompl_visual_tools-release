## ompl_visual_tools (indigo) - 2.3.2-0

The packages in the `ompl_visual_tools` repository were released into the `indigo` distro by running `/usr/bin/bloom-release ompl_visual_tools -t indigo -r indigo` on `Wed, 13 Jan 2016 19:49:56 -0000`
